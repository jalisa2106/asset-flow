...
- Track lifecycle statuses: *Available, Allocated, Reserved, Under Maintenance, Lost, Retired, Disposed*.
...
- Approval workflow before the asset is marked as *Under Maintenance*.
...
- Assigned auditors verify assets as *Verified*, *Missing*, or *Damaged*.
