...
-- ============================================================
insert into allocations (id, asset_id, employee_id, department_id, allocated_at, expected_return_date, status) values
  ('f1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000005', null, '2025-03-12', '2026-08-01', 'Active'), -- Priya has AF laptop, active -> triggers conflict UI if re-allocated
  ('f1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000008', 'e1000000-0000-0000-0000-000000000006', null, '2025-01-09', '2026-06-15', 'Active'),
  ('f1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000010', 'e1000000-0000-0000-0000-000000000007', null, '2024-11-20', '2025-05-01', 'Returned'),
  ('f1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000009', null, '2024-06-01', '2024-12-01', 'Returned'),
  ('f1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000007', 'e1000000-0000-0000-0000-000000000010', null, '2025-02-15', '2026-01-10', 'Active'),
  ('f1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000012', 'e1000000-0000-0000-0000-000000000011', null, '2025-05-05', '2025-11-05', 'Returned'),
  ('f1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000004', null, '2023-06-01', null, 'Transferred'),
  ('f1000000-0000-0000-0000-000000000008', 'a1000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000004', null, '2025-04-01', '2025-10-01', 'Returned'),
  ('f1000000-0000-0000-0000-000000000009', 'a1000000-0000-0000-0000-000000000009', null, 'd1000000-0000-0000-0000-000000000003', '2025-07-01', '2026-01-01', 'Active'),
  ('f1000000-0000-0000-0000-000000000010', 'a1000000-0000-0000-0000-000000000013', 'e1000000-0000-0000-0000-000000000012', null, '2022-01-01', '2022-06-01', 'Returned');
